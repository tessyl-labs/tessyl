...
export const RENDER_POLICY = Object.freeze({
  ...
  globalAttributes: [
    ...
    "data-native-caption-visible", "data-native-details-visible",
  ],
  tagAttributes: {
    ...
    path: ["d"], line: ["x1", "x2", "y1", "y2"], polyline: ["points"], circle: ["cx", "cy", "r", "fill-opacity", "stroke-width", "stroke-opacity"],
